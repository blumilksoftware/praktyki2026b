...
<template>
  <div class="relative">
    <BaseInput :id="id" :model-value="modelValue" :label="label" :error="error" :required="required"
    ...
    >
      <li v-for="(suggestion, index) in suggestions" :key="suggestion.id" class="cursor-pointer px-4 py-2 text-sm"
