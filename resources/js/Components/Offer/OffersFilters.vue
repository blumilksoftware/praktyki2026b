  ...
  >
    <div class="flex justify-between items-start gap-3">
      ...
      <div class="flex shrink-0 items-center gap-2">
        ...
        <button
          type="button"
          class="lg:hidden flex justify-center items-center hover:bg-background border border-border cursor-pointer hover:border-primary/40 rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/30 w-8 h-8 text-additional hover:text-text transition"
          :aria-expanded="isExpanded"
          aria-controls="offers-filters-panel"
          :aria-label="isExpanded ? t('student.offers.filters.collapse') : t('student.offers.filters.expand')"
    ...
    <div
      ...
      class="lg:grid-rows-[1fr] grid transition-[grid-template-rows] duration-300 ease-out"
