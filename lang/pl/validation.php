...
return [
    ...
    "nip" => "Proszę wpisać prawidłowy numer NIP.",
    ...
    "terms_accepted_friendly" => "Musisz zaakceptować regulamin.",
    ...
    "faculty_name_unique" => "Ta uczelnia ma już wydział o tej nazwie.",
    "faculty_reassign_required" => "Ten wydział jest używany. Wybierz inny wydział, do którego przeniesiemy jego kierunki.",
